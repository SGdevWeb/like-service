...
```
cd existing_repo
git remote add origin https://gitlab.com/incubateur_m2i_afpa_2/tree-upjs/back-end/like-service.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/incubateur_m2i_afpa_2/tree-upjs/back-end/like-service/-/settings/integrations)
